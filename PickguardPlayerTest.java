...
/**
 * The test class PickguardPlayerTest.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class PickguardPlayerTest {
	Shoes shoe;
	Shoes shoe2;
	Shoes shoe3;
	...
	public void test_play() {
		...
		tennisplayer.play(tennisplayer2);
		assertEquals(93312.4, tennisplayer.getAccumulatedPoints(), 0.1);
	}

	@Test
	public void test_chooseshoes() {
		tennisplayer.setRacket(racket);
		tennisplayer.chooseShoes();
		Shoes sh = tennisplayer.getShoes();
		assertEquals(sh, tennisplayer.getShoes());
